        ...
        <Accordion>
          <Accordion.Item eventKey="0">
            ...
            <Accordion.Body>
              ...
              to create and personalise your account. You’ll be the first to
              know about sales, new releases and top picks in your size.
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="2">
            ...
            <Accordion.Body>
              We offer worldwide delivery via DPD and UPS, just simply enter
              your full delivery address when checking out.
              <br />
          ...
          <Accordion.Item eventKey="3">
            ...
            <Accordion.Body>
              ...
              European Union, Hong Kong SAR China, Iceland, India, Indonesia,
              Isle of Man, Israel, Japan, Kuwait, Malaysia, Mexico, New Zealand,
              Norway, Philippines, Qatar, Russia, Saudi Arabia, Serbia,
              Singapore, South Africa, South Korea, Switzerland, Taiwan,
              Thailand, Turkey, Ukraine, United Arab Emirates, United States,
              Vietnam.
              <br />
              Any other country or region outside the above list is subject to
              pay taxes &amp; duties set by their country upon delivery.
              <br />
              Please note, these fees are the sole responsibility of the
              customer and are non-refundable, even if you return your order.
            </Accordion.Body>
          </Accordion.Item>
          <Accordion.Item eventKey="5">
            <Accordion.Header>Who will deliver my item?</Accordion.Header>
            <Accordion.Body>
              Orders delivered to the UK &amp; Europe will be shipped via DPD,
              and orders delivered internationally will be shipped via UPS. All
          ...
          <Accordion.Item eventKey="4">
            ...
            <Accordion.Body>
              ...
              <br /> We aim for delivery within 3-5 business days after your
              order has been accepted, excluding weekends.
              <br />
              ...
              separate parcels. If applicable, you will receive a tracking
              number for each parcel.
              <br /> If you provided a valid mobile number when placing your
              order, our delivery partner may also send you delivery
