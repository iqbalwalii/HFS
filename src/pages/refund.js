        ...
        <Row>
          <Col xs={12} md={{ offset: 3, span: 6 }} className={styles.refund}>
            ...
            <ul>
              ...
              <li>
                All sneakers must be returned in their original condition with
                the sneaker box and an outer box for protection purposes. Any
                returns sent back without an outer box may be refused and sent
                back to the customer if damaged.
              </li>
              <li>
              ...
              <li>
                Any item purchased in a sale, or with a promotional code are
                only eligible for store credit.
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                Returns are free of charge within the UK by using DPD. We
                request any returns sent back from outside of the UK to be
                returned with tracked shipping to the following address:
              </li>
              <div>
                Unit 13
                <br />
            ...
            <ul>
              ...
              <li>
                Any items purchased in store are only eligible for store credit
                or an exchange, and you have 14 days from the date of purchase
                to return these back to us.
              </li>
              <li>
              ...
              <li>
                All sneakers must be brought back in their original condition
                with their original sneaker box.
              </li>
            </ul>
          </Col>
        </Row>
