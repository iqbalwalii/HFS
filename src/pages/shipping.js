      ...
      <Container>
        <Row>
          <Col xs={12} md={{ span: 6, offset: 3 }} className={styles.shipping}>
            ...
            <p>
              Please note your goods will only be shipped Monday-Friday.
              Shipping timing begins when you receive the shipping confirmation
              email.
            </p>
            <p>
            ...
            <p>
              A signature will be required on delivery, someone else can sign
              for the package.
            </p>
            <p>
            ...
            <p>
              ...
              accommodation, hotels, restaurants, stores, or forwarding
              addresses.
            </p>
            <p>
            ...
            <p>
              Confirmation e-mail, Official photo ID (passport or driving
              license) and Payment card used for the order.
            </p>
          </Col>
        </Row>
      </Container>
